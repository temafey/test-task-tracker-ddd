...
#[AutoconfigureTag(name: 'tactician.handler', attributes: [
	'command' => 'Micro\Tracker\Task\Domain\Query\FetchOneUserQuery',
	'bus' => 'query.task'
])]
class FetchOneUserHandler implements QueryHandlerInterface
{
    /**
     * Constructor
     */
    ...
    /**
     * Handle FetchOneUserQuery query.
	 *
	 * @param QueryInterface|FetchOneUserQuery $fetchOneUserQuery
     */
    public function handle(QueryInterface $fetchOneUserQuery): ?UserReadModelInterface
    {
        return $this->userRepository->fetchOne($fetchOneUserQuery->getUuid());
    }
}
